...
import 'models/fb2_body.dart';
import 'models/fb2_description.dart';
import 'models/fb2_image.dart';
...
///    String fileContent = await file.readAsString();
    ...
    //parseDescription(fileContent); // TODO check correct parse
    //print(description);
    description = FB2Description("", null);
  ...
  void parseBody(String fileContent) {
    ...
    print("Body group len: ${bodyRegExp.groupCount}");
    body = FB2Body(bodyRegExp.group(1)!);
    print(body.sections!.length);
  }
